...
import { marker, mapmarker } from "../../model/googlemap-models";
...
@Component({
  selector: "app-tabs-directions",
  templateUrl: "./tabs-directions.component.html",
  styleUrls: ["./tabs-directions.component.css"],
})
export class TabsDirectionsComponent implements OnInit {
  // public value: any;
  ...
  //   let Z = this.R * Y;
  //   this.info_details =
  //     '<h4>Distance</h4><span class="emphasisclass">The Last Line Drawn in Miles: </span>' +
  //     (Z / 1609.344).toFixed(2);
  // }
  ...
  //       if (
  //         google.maps.geometry.poly.containsLocation(this.LatLng, drawnPoly)
  //       ) {
  //         companyList +=
  //           "<tr><td>" +
  //           item.get("title") +
  ...
  //     Math.cos(this.findRad(x)) *
  //       Math.cos(this.findRad(y)) *
  //       Math.sin(b / 2) *
  //       Math.sin(b / 2);
  //   return SinCos;
  // }
  ...
  //   thisComponent.geo_coder.geocode(
  //     { address: thisComponent.searchValue },
  //     function (results, status) {
  //       if (status.toString() == "OK") {
  //         thisComponent.googleMap.setCenter(
  ...
  //         thisComponent.marker.setPosition(
  //           new google.maps.LatLng(
  //             results[0].geometry.location.lat(),
  //             results[0].geometry.location.lng()
  //           )
